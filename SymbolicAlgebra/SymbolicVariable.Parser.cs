...
public partial class SymbolicVariable
{
                ...
                if (parse_separators.Contains(expr[ix]))
                {
                    if ((expr[ix] == '-' || expr[ix] == '+') && ix == 0)
                    {
                        if (expr[ix] == '-')
                        {
                            ...
                            //  of -1 * x
                            ep.SymbolicExpression = NegativeOne;
                            ep.Operation = "*";
                    ...
                    else
                    {
                        ...
                        if (Inner)
                        {
                            ...
                            {
                                ep.SymbolicExpression = Multiply(NegativeOne, ep.SymbolicExpression);
    ...
    public double Execute(Dictionary<string, double> parameters)
    {
        ...
        var pcount = InvolvedSymbols.Length;
    ...
    public double Execute(params double[] parameters)
    {
        ...
        var pcount = GetInvolvedSymbols().Length;
