        ...
        if (val.IsQsValue)
        {
            if (val.ParameterValue is QsScalar)
            {
                ...
                else if (pval.ScalarType == ScalarTypes.NumericalQuantity)
                {
                    ...
                    if (q.Dimension.IsDimensionless)
                    {
                        double r = SymbolicAlgebra.CoMath.Sec((ZeroAngle + q).Value);
                        return r.ToQuantity().ToScalarValue();
                    }
                    else
                    {
        ...
        if (val.IsQsValue)
        {
            if (val.ParameterValue is QsScalar)
            {
                ...
                else if (pval.ScalarType == ScalarTypes.NumericalQuantity)
                {
                    ...
                    if (q.Dimension.IsDimensionless)
                    {
                        double r = SymbolicAlgebra.CoMath.Csc((ZeroAngle + q).Value);
                        return r.ToQuantity().ToScalarValue();
                    }
                    else
                    {
        ...
        if (val.IsQsValue)
        {
            if (val.ParameterValue is QsScalar)
            {
                ...
                else if (pval.ScalarType == ScalarTypes.NumericalQuantity)
                {
                    ...
                    if (q.Dimension.IsDimensionless)
                    {
                        double r = SymbolicAlgebra.CoMath.Cot((ZeroAngle + q).Value);
                        return r.ToQuantity().ToScalarValue();
                    }
                    else
                    {
        ...
        if (val.IsQsValue)
        {
            if (val.ParameterValue is QsScalar)
            {
                ...
                else if (pval.ScalarType == ScalarTypes.NumericalQuantity)
                {
                    ...
                    if (q.Dimension.IsDimensionless)
                    {
                        double r = SymbolicAlgebra.CoMath.Sech((ZeroAngle + q).Value);
                        return r.ToQuantity().ToScalarValue();
                    }
                    else
                    {
        ...
        if (val.IsQsValue)
        {
            if (val.ParameterValue is QsScalar)
            {
                ...
                else if (pval.ScalarType == ScalarTypes.NumericalQuantity)
                {
                    ...
                    if (q.Dimension.IsDimensionless)
                    {
                        double r = SymbolicAlgebra.CoMath.Csch((ZeroAngle + q).Value);
                        return r.ToQuantity().ToScalarValue();
                    }
                    else
                    {
        ...
        if (val.IsQsValue)
        {
            if (val.ParameterValue is QsScalar)
            {
                ...
                else if (pval.ScalarType == ScalarTypes.NumericalQuantity)
                {
                    ...
                    if (q.Dimension.IsDimensionless)
                    {
                        double r = SymbolicAlgebra.CoMath.Coth((ZeroAngle + q).Value);
                        return r.ToQuantity().ToScalarValue();
                    }
                    else
                    {
        ...
        if (val.IsQsValue)
        {
            if (val.ParameterValue is QsScalar)
            {
                ...
                else if (pval.ScalarType == ScalarTypes.NumericalQuantity)
                {
                    ...
                    if (q.Dimension.IsDimensionless)
                    {
                        double r = SymbolicAlgebra.CoMath.Acosh((ZeroAngle + q).Value);
                        return r.ToQuantity().ToScalarValue();
                    }
                    else
                    {
        ...
        if (val.IsQsValue)
        {
            if (val.ParameterValue is QsScalar)
            {
                ...
                else if (pval.ScalarType == ScalarTypes.NumericalQuantity)
                {
                    ...
                    if (q.Dimension.IsDimensionless)
                    {
                        double r = SymbolicAlgebra.CoMath.Asinh((ZeroAngle + q).Value);
                        return r.ToQuantity().ToScalarValue();
                    }
                    else
                    {
        ...
        if (val.IsQsValue)
        {
            if (val.ParameterValue is QsScalar)
            {
                ...
                else if (pval.ScalarType == ScalarTypes.NumericalQuantity)
                {
                    ...
                    if (q.Dimension.IsDimensionless)
                    {
                        double r = SymbolicAlgebra.CoMath.Atanh((ZeroAngle + q).Value);
                        return r.ToQuantity().ToScalarValue();
                    }
                    else
                    {
        ...
        if (val.IsQsValue)
        {
            if (val.ParameterValue is QsScalar)
            {
                ...
                else if (pval.ScalarType == ScalarTypes.NumericalQuantity)
                {
                    ...
                    if (q.Dimension.IsDimensionless)
                    {
                        double r = SymbolicAlgebra.CoMath.Asec((ZeroAngle + q).Value);
                        return r.ToQuantity().ToScalarValue();
                    }
                    else
                    {
        ...
        if (val.IsQsValue)
        {
            if (val.ParameterValue is QsScalar)
            {
                ...
                else if (pval.ScalarType == ScalarTypes.NumericalQuantity)
                {
                    ...
                    if (q.Dimension.IsDimensionless)
                    {
                        double r = SymbolicAlgebra.CoMath.Acsc((ZeroAngle + q).Value);
                        return r.ToQuantity().ToScalarValue();
                    }
                    else
                    {
        ...
        if (val.IsQsValue)
        {
            if (val.ParameterValue is QsScalar)
            {
                ...
                else if (pval.ScalarType == ScalarTypes.NumericalQuantity)
                {
                    ...
                    if (q.Dimension.IsDimensionless)
                    {
                        double r = SymbolicAlgebra.CoMath.Acot((ZeroAngle + q).Value);
                        return r.ToQuantity().ToScalarValue();
                    }
                    else
                    {
        ...
        if (val.IsQsValue)
        {
            if (val.ParameterValue is QsScalar)
            {
                ...
                else if (pval.ScalarType == ScalarTypes.NumericalQuantity)
                {
                    ...
                    if (q.Dimension.IsDimensionless)
                    {
                        double r = SymbolicAlgebra.CoMath.Asech((ZeroAngle + q).Value);
                        return r.ToQuantity().ToScalarValue();
                    }
                    else
                    {
        ...
        if (val.IsQsValue)
        {
            if (val.ParameterValue is QsScalar)
            {
                ...
                else if (pval.ScalarType == ScalarTypes.NumericalQuantity)
                {
                    ...
                    if (q.Dimension.IsDimensionless)
                    {
                        double r = SymbolicAlgebra.CoMath.Acsch((ZeroAngle + q).Value);
                        return r.ToQuantity().ToScalarValue();
                    }
                    else
                    {
        ...
        if (val.IsQsValue)
        {
            if (val.ParameterValue is QsScalar)
            {
                ...
                else if (pval.ScalarType == ScalarTypes.NumericalQuantity)
                {
                    ...
                    if (q.Dimension.IsDimensionless)
                    {
                        double r = SymbolicAlgebra.CoMath.Acoth((ZeroAngle + q).Value);
                        return r.ToQuantity().ToScalarValue();
                    }
                    else
                    {
